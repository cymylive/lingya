...
"  };",
  ...
  "  };",
  "  globalThis.memorySave = async function (memory) {",
  "    return await __call('memory_save', memory || {});",
  "  };",
  "  globalThis.memoryUpdate = async function (memory) {",
  "    return await __call('memory_update', memory || {});",
  "  };",
  "  globalThis.memoryDelete = async function (id) {",
  "    return await __call('memory_delete', { id: id });",
  "  };",
  "  globalThis.memoryList = async function (options) {",
  "    return await __call('memory_list', options || {});",
  "  };",
  "  globalThis.webSearch = async function (query, options) {",
  "    options = options || {};",
  "    return await __call('web_search', { query: query, topK: options.topK });",
  "  };",
